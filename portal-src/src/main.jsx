...
function ClientDashboard({ state, setPage, profile }) {
  ...
  return <div className="page-stack"><section className="welcome"><div><p className="overline">Client workspace</p><h1>Welcome back, {firstName}.</h1><p>{businessName} · Current content cycle</p></div><div className="subscription"><span>Subscription</span><b>Active · $450/month</b><small>Manage details in Billing</small></div></section>
