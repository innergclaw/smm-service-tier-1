...
for (const marker of ["The Luxe Beauty Studio", "Instagram", "Facebook", "$450", "$250.00", "OWY-INV-2026-0701", "Email verification enabled", "Spam or Junk", "Private shared workspace", "client_media_assets", "client-media", "Stripe-ready billing"]) {
